...
def main(url):
    #url = 'http://hjedd.com/post/details?pid=446352'
    #pid = url.split("=")[1]
    #print(url)
    pid= url
    url_new = 'http://hjedd.com/api/topic/'+pid
    HEADERS = {
        'Host': 'hjedd.com',
    ...
    url_all = result_body["data"]["attachments"]
    title = result_body["data"]["title"]
    url_num = len(url_all)
...
def main2():
    url = 'http://hjedd.com/post/details?pid=267410'
    #pid = url.split("=")[1]
    #print(url)
    pid= '267410'
    url_new = 'http://hjedd.com/api/topic/'+pid
